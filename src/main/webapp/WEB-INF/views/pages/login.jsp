...
<%--<body style="display:flex;align-items:center;height:100vh;background:#f5f7fb; width: 100%">--%>

<%--<div style="background-image: url('${pageContext.request.contextPath}/assets/images/hotel-sidepic.jpg');--%>
<%--        background-size: cover;--%>
<%--        background-position: center; width: 50%; height: 100vh">--%>
<%--</div>--%>

<%--<div style="width:100%;padding:40px;border: 1px solid red; display: flex; justify-content: center; align-items: center">--%>

<%--    <div style="width: 100%; max-width: 400px">--%>

<%--    <h2 style="text-align:center;margin-bottom:25px;color:#333;">Ocean View Resort </h2>--%>
