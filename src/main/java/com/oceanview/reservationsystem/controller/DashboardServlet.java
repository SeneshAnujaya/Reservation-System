...
import com.oceanview.reservationsystem.dao.DashboardDAO;
...
public class DashboardServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("todayCheckins", dashboardDAO.getTodayCheckins());
        request.setAttribute("todayCheckouts", dashboardDAO.getTodayCheckouts());
